...
START_TEST(s21_sum_matrix_03) {
  ...
  s21_create_matrix(4, 4, &A);
  s21_fill_matrix(-3.0, &A);

  s21_create_matrix(4, 4, &B);
  s21_fill_matrix(5.0, &B);
...
START_TEST(s21_sum_matrix_04) {
  ...
  s21_create_matrix(4, 4, &A);
  s21_fill_matrix(5.0, &A);

  s21_create_matrix(4, 4, &B);
  s21_fill_matrix(-3.0, &B);
...
START_TEST(s21_determinant_05) {
  ...
  s21_determinant(&A, &det);
  ck_assert_double_eq(det, -1301.223);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_inverse_matrix_02) {
  ...
  ck_assert_float_eq(Z.matrix[0][0], 0.5);
  ck_assert_int_eq(res, OK);
  s21_remove_matrix(&A);
  s21_remove_matrix(&Z);
}
...
int main(void) {
  ...
  tcase_add_test(tc1_1, s21_create_matrix_11);
  ...
  tcase_add_test(tc1_1, s21_eq_matrix_07);
  ...
  tcase_add_test(tc1_1, s21_calc_complements_05);
